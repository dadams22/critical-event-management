...
import { Badge, Box, Flex, Group, Input, MantineColor, Menu, Paper, Space, Stack, Text} from "@mantine/core";
...
export default function SearchBar({}: ComponentProps) {
    ...
    return (
        <Box w={400} pos="relative">
            <Input w={400} icon={<IconSearch size={16} />} placeholder="Search..." opacity={0.8} onFocus={handleFocus} onBlur={handleBlur} />
            {menuOpen && (
