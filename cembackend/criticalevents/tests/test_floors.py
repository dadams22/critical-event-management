...
class FloorViewSetTest(TestCase):
    ...
    def test_get_floors(self):
        response = self.client.get('/api/floor/')  # replace with your actual FloorViewSet url
    ...
    def test_create_floor_in_current_site(self):
        ...
        new_floor_data = {
            ...
            'sort_order': 2,
            'floor_plan_bounds': '{}',
            'floor_plan': SimpleUploadedFile('floor_plan.jpg', image_file.read(), content_type='image/jpeg')
        }
