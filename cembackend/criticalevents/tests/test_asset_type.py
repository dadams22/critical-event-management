...
class AssetTypeViewSetTest(TestCase):
    ...
    def test_get_asset_types(self):
        response = self.client.get('/api/asset_type/')  # replace with your actual AssetTypeViewSet url
    ...
    def test_get_asset_types_from_different_organization(self):
        ...
        self.assertNotIn('Other Asset Type', [asset_type['name'] for asset_type in response.data])